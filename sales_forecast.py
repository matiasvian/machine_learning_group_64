...
class forecast_model:
    ...
    def __init__(self):
        ...
        # Loading data
        self.test_data = pd.read_csv('machine_learning_group_64/data/beer_test.csv')      # id,       Date,       ts_id,      isPromo
        self.train_data = pd.read_csv('machine_learning_group_64/data/beer_train.csv')    # id,       Date,       ts_id,      isPromo
        self.stores = pd.read_csv('machine_learning_group_64/data/id_store_sku.csv')      # ts_id,    Store,      SKU
        self.features = pd.read_csv('machine_learning_group_64/data/sku_features.csv')    # SKU,      Segment,    Pack,       Product,    Brand,  Volume
    ...
    def benchmark(self):
        ...
        submission = pd.read_csv('machine_learning_group_64/data/sampleSubmission.csv')

        submission['Sales'] = 0.32

        submission.to_csv('machine_learning_group_64/data/submission.csv', index = False)
